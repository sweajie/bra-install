<?php
namespace app\bra\utils\segment;
/*
...
class PhpAnalysis
{
    ...
    public $addonDicFile = SYS_PATH . 'data' . DS .'dicts' . DS . 'PhpAnalysis' . DS . 'words_addons.dic';
    ...
    public $mainDicFile =  SYS_PATH . 'data' . DS .'dicts' . DS . 'PhpAnalysis' . DS . 'base_dic_full.dic';
